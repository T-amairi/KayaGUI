...
*/
CartesianChart::CartesianChart(sf::Color back_ground_color,sf::Color axes_color,sf::Color scale_color,
sf::Font font, sf::Color font_color)
    : data_set_(), axes_(back_ground_color,axes_color,scale_color,font,font_color)
{
