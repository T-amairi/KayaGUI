 ...
 * @see   plot_config
*/
CartesianAxes::CartesianAxes(sf::Color back_ground_color,sf::Color axes_color,sf::Color scale_color,
sf::Font font, sf::Color font_color)
    : x_range_(), y_range_(), font_(font), font_color_(font_color),
      axes_color_(axes_color), scale_color_(scale_color)
{
